		...
		<div>
			<table class="table table-hover">
				...
				<tr>
					...
					<th class="text-center"><em>${product.quantity}</em></th>
					<th class="text-center"><em><fmt:formatNumber value="${product.uniPrice}" pattern="#,###" />원</em></th>
					<th class="text-center"><fmt:formatNumber value="${product.uniPrice*product.quantity}" pattern="#,###" />원</th>
				</tr>
					<!-- sum으로 누적 -->
